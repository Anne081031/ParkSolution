...
private:
    ...
    bool SamePlateInInterval( bool bEnter, const QString& strPlate, const QString& strDateTime );
    bool TimeDifferenceInInterval( const QString& strStart, const QString& strEnd, int nInterval );
