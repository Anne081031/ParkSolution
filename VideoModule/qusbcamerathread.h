#ifndef QUSBCAMERATHREAD_H
#define QUSBCAMERATHREAD_H

#include "QAnalogCameraThread.h"
#include <QLibrary>

class QUsbCameraThread : public QAnalogCameraThread
{
    Q_OBJECT
public:
...
private:
    explicit QUsbCameraThread(QObject *parent = 0);
