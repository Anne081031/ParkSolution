...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QImageLabel_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 42, 11)
    ...
    "QImageLabel\0DoubleCickEvent\0\0QMouseEvent*\0"
    "nImageIndex"
};
...
void QImageLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->DoubleCickEvent((*reinterpret_cast< QMouseEvent*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (QImageLabel::*_t)(QMouseEvent * , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QImageLabel::DoubleCickEvent)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject QImageLabel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_QImageLabel.data,
      qt_meta_data_QImageLabel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QImageLabel.stringdata))
...
// SIGNAL 0
void QImageLabel::DoubleCickEvent(QMouseEvent * _t1, int _t2)
{
