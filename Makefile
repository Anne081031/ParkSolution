...
# Template: subdirs
# Command: F:\Qt\Qt5.2.1\5.2.1\mingw48_32\bin\qmake.exe -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ParkSolution.pro
#############################################################################
...
sub-LPRModule: FORCE
	@if not exist LPRModule\ mkdir LPRModule\ & if not exist LPRModule\ exit 1
	cd LPRModule\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\LPRModule\LPRModule.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile
sub-LPRModule-make_first: FORCE
	@if not exist LPRModule\ mkdir LPRModule\ & if not exist LPRModule\ exit 1
	cd LPRModule\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\LPRModule\LPRModule.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile 
sub-LPRModule-all: FORCE
	@if not exist LPRModule\ mkdir LPRModule\ & if not exist LPRModule\ exit 1
	cd LPRModule\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\LPRModule\LPRModule.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile all
sub-LPRModule-clean: FORCE
	@if not exist LPRModule\ mkdir LPRModule\ & if not exist LPRModule\ exit 1
	cd LPRModule\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\LPRModule\LPRModule.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile clean
sub-LPRModule-distclean: FORCE
	@if not exist LPRModule\ mkdir LPRModule\ & if not exist LPRModule\ exit 1
	cd LPRModule\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\LPRModule\LPRModule.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile distclean
sub-LPRModule-install_subtargets: FORCE
	@if not exist LPRModule\ mkdir LPRModule\ & if not exist LPRModule\ exit 1
	cd LPRModule\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\LPRModule\LPRModule.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile install
sub-LPRModule-uninstall_subtargets: FORCE
	@if not exist LPRModule\ mkdir LPRModule\ & if not exist LPRModule\ exit 1
	cd LPRModule\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\LPRModule\LPRModule.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile uninstall
...
sub-VideoModule-qmake_all:  FORCE
	...
	cd VideoModule\ && $(QMAKE) D:\ParkSolution\VideoModule\VideoModule.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile
	cd VideoModule\ && $(MAKE) -f Makefile qmake_all
sub-VideoModule: FORCE
	@if not exist VideoModule\ mkdir VideoModule\ & if not exist VideoModule\ exit 1
	cd VideoModule\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\VideoModule\VideoModule.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile
sub-VideoModule-make_first: FORCE
	@if not exist VideoModule\ mkdir VideoModule\ & if not exist VideoModule\ exit 1
	cd VideoModule\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\VideoModule\VideoModule.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile 
sub-VideoModule-all: FORCE
	@if not exist VideoModule\ mkdir VideoModule\ & if not exist VideoModule\ exit 1
	cd VideoModule\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\VideoModule\VideoModule.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile all
sub-VideoModule-clean: FORCE
	@if not exist VideoModule\ mkdir VideoModule\ & if not exist VideoModule\ exit 1
	cd VideoModule\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\VideoModule\VideoModule.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile clean
sub-VideoModule-distclean: FORCE
	@if not exist VideoModule\ mkdir VideoModule\ & if not exist VideoModule\ exit 1
	cd VideoModule\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\VideoModule\VideoModule.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile distclean
sub-VideoModule-install_subtargets: FORCE
	@if not exist VideoModule\ mkdir VideoModule\ & if not exist VideoModule\ exit 1
	cd VideoModule\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\VideoModule\VideoModule.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile install
...
sub-ParkServer: FORCE
	@if not exist ParkServer\ mkdir ParkServer\ & if not exist ParkServer\ exit 1
	cd ParkServer\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\ParkServer\ParkServer.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile
sub-ParkServer-make_first: FORCE
	@if not exist ParkServer\ mkdir ParkServer\ & if not exist ParkServer\ exit 1
	cd ParkServer\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\ParkServer\ParkServer.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile 
sub-ParkServer-all: FORCE
	@if not exist ParkServer\ mkdir ParkServer\ & if not exist ParkServer\ exit 1
	cd ParkServer\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\ParkServer\ParkServer.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile all
sub-ParkServer-clean: FORCE
	@if not exist ParkServer\ mkdir ParkServer\ & if not exist ParkServer\ exit 1
	cd ParkServer\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\ParkServer\ParkServer.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile clean
sub-ParkServer-distclean: FORCE
	@if not exist ParkServer\ mkdir ParkServer\ & if not exist ParkServer\ exit 1
	cd ParkServer\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\ParkServer\ParkServer.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile distclean
sub-ParkServer-install_subtargets: FORCE
	@if not exist ParkServer\ mkdir ParkServer\ & if not exist ParkServer\ exit 1
	cd ParkServer\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\ParkServer\ParkServer.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile install
...
sub-Config-qmake_all:  FORCE
	...
	cd Config\ && $(QMAKE) D:\ParkSolution\Config\Config.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile
	cd Config\ && $(MAKE) -f Makefile qmake_all
sub-Config: FORCE
	@if not exist Config\ mkdir Config\ & if not exist Config\ exit 1
	cd Config\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\Config\Config.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile
sub-Config-make_first: FORCE
	@if not exist Config\ mkdir Config\ & if not exist Config\ exit 1
	cd Config\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\Config\Config.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile 
sub-Config-all: FORCE
	@if not exist Config\ mkdir Config\ & if not exist Config\ exit 1
	cd Config\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\Config\Config.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile all
sub-Config-clean: FORCE
	@if not exist Config\ mkdir Config\ & if not exist Config\ exit 1
	cd Config\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\Config\Config.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile clean
sub-Config-distclean: FORCE
	@if not exist Config\ mkdir Config\ & if not exist Config\ exit 1
	cd Config\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\Config\Config.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile distclean
sub-Config-install_subtargets: FORCE
	@if not exist Config\ mkdir Config\ & if not exist Config\ exit 1
	cd Config\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\Config\Config.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile install
sub-Config-uninstall_subtargets: FORCE
	@if not exist Config\ mkdir Config\ & if not exist Config\ exit 1
	cd Config\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\Config\Config.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile uninstall
...
Makefile: ParkSolution.pro F:/Qt/Qt5.2.1/5.2.1/mingw48_32/mkspecs/win32-g++/qmake.conf F:/Qt/Qt5.2.1/5.2.1/mingw48_32/mkspecs/features/spec_pre.prf \
		...
		F:/Qt/Qt5.2.1/5.2.1/mingw48_32/mkspecs/features/qml_debug.prf \
		F:/Qt/Qt5.2.1/5.2.1/mingw48_32/mkspecs/features/declarative_debug.prf \
...
qmake_all: sub-CommonModule-qmake_all sub-ConfigModule-qmake_all sub-AssessibilityModule-qmake_all sub-DatabaseModule-qmake_all sub-LPRModule-qmake_all sub-NetworkModule-qmake_all sub-VideoModule-qmake_all sub-SerialPortModule-qmake_all sub-ParkServer-qmake_all sub-Config-qmake_all FORCE

make_first: sub-CommonModule-make_first sub-ConfigModule-make_first sub-AssessibilityModule-make_first sub-DatabaseModule-make_first sub-LPRModule-make_first sub-NetworkModule-make_first sub-VideoModule-make_first sub-SerialPortModule-make_first sub-ParkServer-make_first sub-Config-make_first FORCE
all: sub-CommonModule-all sub-ConfigModule-all sub-AssessibilityModule-all sub-DatabaseModule-all sub-LPRModule-all sub-NetworkModule-all sub-VideoModule-all sub-SerialPortModule-all sub-ParkServer-all sub-Config-all FORCE
clean: sub-CommonModule-clean sub-ConfigModule-clean sub-AssessibilityModule-clean sub-DatabaseModule-clean sub-LPRModule-clean sub-NetworkModule-clean sub-VideoModule-clean sub-SerialPortModule-clean sub-ParkServer-clean sub-Config-clean FORCE
distclean: sub-CommonModule-distclean sub-ConfigModule-distclean sub-AssessibilityModule-distclean sub-DatabaseModule-distclean sub-LPRModule-distclean sub-NetworkModule-distclean sub-VideoModule-distclean sub-SerialPortModule-distclean sub-ParkServer-distclean sub-Config-distclean FORCE
	-$(DEL_FILE) Makefile
...
sub-Config-debug:
	@if not exist Config\ mkdir Config\ & if not exist Config\ exit 1
	cd Config\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\Config\Config.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile debug
debug: sub-CommonModule-debug sub-ConfigModule-debug sub-AssessibilityModule-debug sub-DatabaseModule-debug sub-LPRModule-debug sub-NetworkModule-debug sub-VideoModule-debug sub-SerialPortModule-debug sub-ParkServer-debug sub-Config-debug
...
sub-Config-release:
	@if not exist Config\ mkdir Config\ & if not exist Config\ exit 1
	cd Config\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\Config\Config.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile release
release: sub-CommonModule-release sub-ConfigModule-release sub-AssessibilityModule-release sub-DatabaseModule-release sub-LPRModule-release sub-NetworkModule-release sub-VideoModule-release sub-SerialPortModule-release sub-ParkServer-release sub-Config-release
...
sub-Config-check:
	@if not exist Config\ mkdir Config\ & if not exist Config\ exit 1
	cd Config\ && ( if not exist Makefile $(QMAKE) D:\ParkSolution\Config\Config.pro -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile check
check: sub-CommonModule-check sub-ConfigModule-check sub-AssessibilityModule-check sub-DatabaseModule-check sub-LPRModule-check sub-NetworkModule-check sub-VideoModule-check sub-SerialPortModule-check sub-ParkServer-check sub-Config-check
